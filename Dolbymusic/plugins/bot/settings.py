...
from Dolbymusic.utils.decorators.admins import ActualAdminCB
from Dolbymusic.utils.decorators.language import language, languageCB
from Dolbymusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Dolbymusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaPhoto("https://freeimage.host/i/F0WYZ42", caption="<b><u>Fᴇᴇʟ Fʀᴇᴇ ᴛᴏ Dᴏɴᴀᴛᴇ</u></b>\n\nUᴘɪ ɪᴅ: satyammahajan070@paytm\nBɪɴᴀɴᴄᴇ ɪᴅ: 824335517"),
    ),
    return await CallbackQuery.edit_message_reply_markup(
        reply_markup=InlineKeyboardMarkup(
        [[InlineKeyboardButton(text="•ʙᴀᴄᴋ•", callback_data=f"settingsback_helper")]]
